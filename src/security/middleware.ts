...
function describeMutation(req: Request): {
    ...
    const mappings: Array<[RegExp, string, string?]> = [
        ...
        [/^\/api\/jobs\/test-run$/u, 'execution.test_queue', 'job'],
        [/^\/api\/jobs\/bulk-status$/u, 'job.bulk_status', 'job'],
        [/^\/api\/jobs\/([^/]+)\/rollback$/u, 'job.rollback', 'job'],
        [/^\/api\/jobs\/([^/]+)\/triggers\/[^/]+\/rotate-token$/u, 'automation.token_rotate', 'job'],
        [/^\/api\/jobs\/([^/]+)\/triggers\/[^/]+$/u, req.method === 'DELETE' ? 'automation.delete' : 'automation.update', 'job'],
        [/^\/api\/jobs\/([^/]+)\/triggers$/u, 'automation.create', 'job'],
        [/^\/api\/jobs\/([^/]+)\/run\/validate$/u, 'execution.input_validate', 'job'],
        [/^\/api\/jobs\/([^/]+)\/backfills\/preview$/u, 'backfill.preview', 'job'],
        [/^\/api\/jobs\/([^/]+)\/backfills$/u, 'backfill.apply', 'job'],
        ...
        [/^\/api\/executions\/([^/]+)\/replay$/u, 'execution.replay', 'execution'],
        [/^\/api\/attention\/bulk$/u, 'attention.bulk', 'attention'],
        [/^\/api\/attention\/([^/]+)\/(acknowledge|snooze|assign|severity|resolve|replay)$/u, 'attention.lifecycle', 'attention'],
        ...
        [/^\/api\/workers\/([^/]+)\/drain$/u, 'worker.drain', 'worker'],
        [/^\/api\/workers\/([^/]+)\/resume$/u, 'worker.resume', 'worker'],
        [/^\/api\/queues\/([^/]+)$/u, 'queue.policy_update', 'queue'],
        [/^\/api\/notifications\/channels\/([^/]+)$/u, 'notification.channel_update', 'notification_channel'],
        [/^\/api\/notifications\/channels$/u, 'notification.channel_create', 'notification_channel'],
        [/^\/api\/notifications\/policies\/([^/]+)$/u, 'notification.policy_update', 'notification_policy'],
        [/^\/api\/notifications\/policies$/u, 'notification.policy_create', 'notification_policy'],
        [/^\/api\/notifications\/deliveries\/([^/]+)\/retry$/u, 'notification.delivery_retry', 'notification_delivery'],
